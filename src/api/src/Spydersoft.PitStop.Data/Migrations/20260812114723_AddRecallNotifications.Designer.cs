...
namespace Spydersoft.PitStop.Data.Migrations
{
    ...
    [Migration("20260812114723_AddRecallNotifications")]
    partial class AddRecallNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spydersoft.PitStop.Data.Entities.MaintenanceLogAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MaintenanceLogAttachments");
                });

            modelBuilder.Entity("Spydersoft.PitStop.Data.Entities.RecallNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Spydersoft.PitStop.Data.Entities.MaintenanceLogAttachment", b =>
                {
                    b.HasOne("Spydersoft.PitStop.Data.Entities.MaintenanceLog", "MaintenanceLog")
            ...
            modelBuilder.Entity("Spydersoft.PitStop.Data.Entities.Vehicle", b =>
                {
                    ...
                    b.Navigation("RecallNotifications");
                });
